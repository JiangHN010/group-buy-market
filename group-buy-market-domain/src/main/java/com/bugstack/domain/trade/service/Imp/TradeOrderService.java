...
public class TradeOrderService implements ITradeOrderService {
    ...
    @Resource
    private BusinessLinkedList<TradeRuleCommandEntity, TradeRuleFilterFactory.DynamicContext, TradeRuleFilterBackEntity> tradeRuleFilters;
    ...
    public MarketPayOrderEntity lockMarketPayOrder(UserEntity userEntity, PayActivityEntity payActivityEntity, PayDiscountEntity payDiscountEntity) throws Exception {
        ...
        TradeRuleFilterBackEntity tradeRuleFilterBackEntity = tradeRuleFilters.apply(TradeRuleCommandEntity.builder()
