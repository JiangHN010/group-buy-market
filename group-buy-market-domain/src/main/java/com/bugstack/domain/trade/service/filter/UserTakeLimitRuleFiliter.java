package com.bugstack.domain.trade.service.filter;
...
import com.bugstack.domain.trade.service.factory.TradeRuleFilterFactory;
import com.bugstack.types.design.framework.link.model2.handler.ILogicHandler;
...
/**
 * @Author Haonan Jiang
 * @Date 2025/12/26 20:51
 * @Description: TODO
 */
@Slf4j
@Service
public class UserTakeLimitRuleFiliter implements ILogicHandler<TradeRuleCommandEntity, TradeRuleFilterFactory.DynamicContext, TradeRuleFilterBackEntity> {
